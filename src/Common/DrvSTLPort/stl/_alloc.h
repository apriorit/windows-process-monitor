...
template <class _Tp, class _Alloc> struct stl__allocator;
# endif
...
# if defined (_STLP_MEMBER_TEMPLATE_CLASSES) && defined (_STLP_USE_RAW_SGI_ALLOCATORS)
  template <class _Tp1> struct rebind {
    typedef stl__allocator<_Tp1, __malloc_alloc<__inst> > other;
  };
# endif
...
# if defined (_STLP_MEMBER_TEMPLATE_CLASSES) &&  defined(_STLP_USE_RAW_SGI_ALLOCATORS)
  template <class _Tp1> struct rebind {
    typedef stl__allocator<_Tp1, __new_alloc > other;
  };
# endif
...
# if defined (_STLP_MEMBER_TEMPLATE_CLASSES) && defined (_STLP_USE_RAW_SGI_ALLOCATORS)
    template <class _Tp1> struct rebind {
        typedef stl__allocator< _Tp1, __debug_alloc<_Alloc> > other;
    };
# endif
    __debug_alloc() {}
    ~__debug_alloc() {}
...
# if defined (_STLP_MEMBER_TEMPLATE_CLASSES) && defined (_STLP_USE_RAW_SGI_ALLOCATORS)
  template <class _Tp1> struct rebind {
    typedef stl__allocator<_Tp1, __node_alloc<__threads, __inst> > other;
  };
# endif
  /* __n must be > 0      */
