...
// stl__allocator<_Tp, alloc> is essentially the same thing as allocator<_Tp>.

template <class _Tp, class _Alloc>
struct stl__allocator : public _Alloc {
...
# if defined (_STLP_MEMBER_TEMPLATE_CLASSES)
  template <class _Tp1> struct rebind {
    typedef stl__allocator<_Tp1, _Alloc> other;
  };
# endif
  stl__allocator() _STLP_NOTHROW {}
  stl__allocator(const _Alloc& ) _STLP_NOTHROW {}
  stl__allocator(const stl__allocator<_Tp, _Alloc>& __a) _STLP_NOTHROW
    : _Alloc(__a) {}
# if defined (_STLP_MEMBER_TEMPLATES) && defined (_STLP_FUNCTION_TMPL_PARTIAL_ORDER)
  template <class _Tp1>
  stl__allocator(const stl__allocator<_Tp1, _Alloc>& __a) _STLP_NOTHROW
    : _Alloc(__a) {}
# endif
...
struct stl__allocator<void, _Alloc> {
  typedef size_t      size_type;
  typedef ptrdiff_t   difference_type;
...
template <class _Tp, class _Alloc>
inline bool  _STLP_CALL operator==(const stl__allocator<_Tp, _Alloc>& __a1,
                                   const stl__allocator<_Tp, _Alloc>& __a2)
{
...
// This ensures that stl__allocator<malloc_alloc> (for example) will
// work correctly.
...
struct _Alloc_traits<_Tp, __malloc_alloc<__inst> > {
  typedef stl__allocator<_Tp, __malloc_alloc<__inst> > allocator_type;
};


template <class _Tp, bool __threads, int __inst>
struct _Alloc_traits<_Tp, __node_alloc<__threads, __inst> > {
  typedef stl__allocator<_Tp, __node_alloc<__threads, __inst> >
          allocator_type;
};

template <class _Tp, class _Alloc>
struct _Alloc_traits<_Tp, __debug_alloc<_Alloc> > {
  typedef stl__allocator<_Tp, __debug_alloc<_Alloc> > allocator_type;
};

// Versions for the stl__allocator adaptor used with the predefined
// SGI-style allocators.

template <class _Tp, class _Tp1, class _Alloc>
struct _Alloc_traits<_Tp, stl__allocator<_Tp1, _Alloc > > {
  typedef stl__allocator<_Tp, _Alloc > allocator_type;
};
...
template <class _Tp>
inline stl__allocator<_Tp, __malloc_alloc_dfl >& _STLP_CALL
__stl_alloc_rebind(__malloc_alloc_dfl& __a, const _Tp*) {
  return (stl__allocator<_Tp, __malloc_alloc_dfl >&)__a;
}

template <class _Tp>
inline stl__allocator<_Tp, __single_client_node_alloc >& _STLP_CALL
__stl_alloc_rebind(__single_client_node_alloc& __a, const _Tp*) {
  return (stl__allocator<_Tp, __single_client_node_alloc >&)__a;
}

template <class _Tp>
inline stl__allocator<_Tp, __multithreaded_node_alloc >& _STLP_CALL
__stl_alloc_rebind(__multithreaded_node_alloc& __a, const _Tp*) {
  return (stl__allocator<_Tp, __multithreaded_node_alloc >&)__a;
}

template <class _Tp>
inline stl__allocator<_Tp, __malloc_alloc_dfl > _STLP_CALL
__stl_alloc_create(const __malloc_alloc_dfl&, const _Tp*) {
  return stl__allocator<_Tp, __malloc_alloc_dfl > ();
}

template <class _Tp>
inline stl__allocator<_Tp, __single_client_node_alloc > _STLP_CALL
__stl_alloc_create(const __single_client_node_alloc&, const _Tp*) {
  return stl__allocator<_Tp, __single_client_node_alloc >();
}

template <class _Tp>
inline stl__allocator<_Tp, __multithreaded_node_alloc > _STLP_CALL
__stl_alloc_create(const __multithreaded_node_alloc&, const _Tp*) {
  return stl__allocator<_Tp, __multithreaded_node_alloc >();
}

#  else

template <class _Tp, int __inst>
inline stl__allocator<_Tp, __malloc_alloc<__inst> >& _STLP_CALL
__stl_alloc_rebind(__malloc_alloc<__inst>& __a, const _Tp*) {
  return (stl__allocator<_Tp, __malloc_alloc<__inst> >&)__a;
}

template <class _Tp, bool __threads, int __inst>
inline stl__allocator<_Tp, __node_alloc<__threads, __inst> >& _STLP_CALL
__stl_alloc_rebind(__node_alloc<__threads, __inst>& __a, const _Tp*) {
  return (stl__allocator<_Tp, __node_alloc<__threads, __inst> >&)__a;
}

template <class _Tp, int __inst>
inline stl__allocator<_Tp, __malloc_alloc<__inst> > _STLP_CALL
__stl_alloc_create(const __malloc_alloc<__inst>&, const _Tp*) {
  return stl__allocator<_Tp, __malloc_alloc<__inst> >();
}

template <class _Tp, bool __threads, int __inst>
inline stl__allocator<_Tp, __node_alloc<__threads, __inst> > _STLP_CALL
__stl_alloc_create(const __node_alloc<__threads, __inst>&, const _Tp*) {
  return stl__allocator<_Tp, __node_alloc<__threads, __inst> >();
}

#  endif

template <class _Tp, class _Alloc>
inline stl__allocator<_Tp, __debug_alloc<_Alloc> > _STLP_CALL
__stl_alloc_create(const __debug_alloc<_Alloc>&, const _Tp*) {
  return stl__allocator<_Tp, __debug_alloc<_Alloc> >();
}
template <class _Tp, class _Alloc>
inline stl__allocator<_Tp, __debug_alloc<_Alloc> >& _STLP_CALL
__stl_alloc_rebind(__debug_alloc<_Alloc>& __a, const _Tp*) {
  return (stl__allocator<_Tp, __debug_alloc<_Alloc> >&)__a;
}

template <class _Tp>
inline stl__allocator<_Tp, __new_alloc > _STLP_CALL
__stl_alloc_create(const __new_alloc&, const _Tp*) {
  return stl__allocator<_Tp, __new_alloc >();
}
template <class _Tp>
inline stl__allocator<_Tp, __new_alloc >&  _STLP_CALL
__stl_alloc_rebind(__new_alloc& __a, const _Tp*) {
  return (stl__allocator<_Tp, __new_alloc >&)__a;
}

template <class _Tp1, class _Alloc, class _Tp2>
inline stl__allocator<_Tp2, _Alloc>& _STLP_CALL
__stl_alloc_rebind(stl__allocator<_Tp1, _Alloc>& __a, const _Tp2*) {
  return (stl__allocator<_Tp2, _Alloc>&)__a;
}

template <class _Tp1, class _Alloc, class _Tp2>
inline stl__allocator<_Tp2, _Alloc> _STLP_CALL
__stl_alloc_create(const stl__allocator<_Tp1, _Alloc>&, const _Tp2*) {
  return stl__allocator<_Tp2, _Alloc>();
}
#endif
